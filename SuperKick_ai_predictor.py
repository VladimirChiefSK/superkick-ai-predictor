...
st.set_page_config(page_title="SuperKick AI Predictor", page_icon="⚽", layout="centered")
...
st.caption("🚫 This is a simulated predictor for entertainment/educational use only.")
